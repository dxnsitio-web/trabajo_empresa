<?php 
   ...
   require_once "../sistemas/gamersvs/config/Conexion.php";
    // --
    ...
    if (rpHash($_POST['defaultReal']) == $_POST['defaultRealHash']) { 
        ...
        //header('Location: http://localhost/Gamer_Vision_2019/reportes/consulta_facturacion_ticket.php?id='.$id.'', true);
        header('Location: https://www.solucionesintegralesjb.com/sistemas/gamersvs/reportes/consulta_facturacion_ticket.php?id='.$id.'', true);
