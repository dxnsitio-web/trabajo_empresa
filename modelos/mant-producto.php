...
Class MantProducto
{
  ...
  public function __construct()
  {
    ...
    public function listar_productos()
    {
      ...
      INNER JOIN (SELECT ddi.idarticulo,count(ddi.idarticulo) as cantidadIngresos, ddi.precio_compra,ddi.precio_venta, ddi.iddetalle_ingreso FROM detalle_ingreso ddi  group by ddi.idarticulo order by ddi.idarticulo desc) di ON di.idarticulo = a.idarticulo order by di.idarticulo desc";
      return ejecutarConsulta($sql);
