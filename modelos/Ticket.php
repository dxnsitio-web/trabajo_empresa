...
Class ticket
{
  ...
  if($saberExiste["serie"] == null && $saberExiste["correlativo"] == null){
      ...
      $ultimoCorrelativo="SELECT max(correlativo) as ultimocorrelativo FROM venta WHERE codigotipo_comprobante='$codigotipo_comprobante'  and serie='$serie'";
