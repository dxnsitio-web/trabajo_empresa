...
<page_header>
		    ...
		    <page_footer>
		        <table id="">
		            <tr class="">
		                <td style="">
		                    <img style="width: 760px;height: 140px;" src="../files/perfil/footer.png">
		                    <!-- 240 -->
		                </td>
		            </tr>
		        </table>
			 ...
			 <table style="width: 100%;">
	        	<tr>
		            <td colspan="2" style="width: 50%">
		                <img style="width: 70%;height: 70px" src="../files/perfil/<?php echo $logo;?>" alt="Logo"><br>
		                
		            </td>
					<td style="width: 13%"></td>
					<td class="factura" style="width:30%">
						<p>PROFORMA 0000000<br>
...
<p class="text">
			Por la presente reciban ustedes un cordial saludo de nuestra empresa SOLUCIONES INTEGRALES JB SAC, con N° RUC.10410697551, así como nuestro agradecimiento, con la finalidad de ponernos a su disposición y ser una alternativa de solución a los requerimientos de su representada.
		</p>
		<div  class="productos">
			<table border="" style="width: 100%;">
				<tr class="cabecera" style="width: 100%; text-align: center">
		            ...
		            <th style="width: 15%; text-align: center;">Precio Venta</th>
				...
				<tr  style="text-align:center">
					...
					<td class="<?php echo $estilo; ?>" style="text-align:left; width: 55%"><?php echo $regd->articulo; ?></td>
					...
					<td class="<?php echo $estilo; ?>" style="width: 15%"><?php echo $regd->precio_venta*$regd->cantidad-$regd->descuento; ?></td>
				</tr>
				...
				<tr  style="text-align:center;">
					<td colspan="3"></td>
					<td style="text-align:right;">Op. gravadas</td>
		...
		<br>
		<P class="text2"  style="color:#3f8dc2;"><b>CONDICIONES GENERALES:</b><br>
			<!-- <div style="padding-left: 10px; ">La forma de pago será en 2 partes:</div> -->

		<div class="cliente">
			<table style="width: 100%;">
				<tr style="color:#3f8dc2;"><td><b>Validez de la oferta</b></td> <td>: 30 dias</td><br></tr>
				<tr style="color:#3f8dc2;"><td><b>Cuenta Ahorro BCP </b></td> <td>: 191-34789343-0-48</td><br></tr>
				<tr style="color:#3f8dc2;"><td><b>Cuenta del titular</b></td> <td>: Wilder Florentino Julca Broncano</td><br></tr>
			</table>
