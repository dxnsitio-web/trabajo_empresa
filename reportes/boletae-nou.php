		...
		<div class="articulos">
			<table border="" style="width: 100%;">
				<tr>
		            ...
		            <th style="width: 10%; text-align: right" >Val. Vta. U.</th>
				...
				<tr  style="text-align:center">
					...
					<td class="<?php echo $estilo; ?>" style="text-align:left;"><?php echo $regd->articulo; ?></td>
					<td class="<?php echo $estilo; ?>"><?php echo $medida; ?></td>
					<td class="<?php echo $estilo; ?>"><?php echo $regd->cantidad; ?></td>
					<td class="<?php echo $estilo; ?>"><?php echo round($regd->precio_venta/1.18,2); ?></td>
					<td class="<?php echo $estilo; ?>"><?php echo $regd->precio_venta; ?></td>
					<td class="<?php echo $estilo; ?>"><?php echo $regd->precio_venta*$regd->cantidad; ?></td>
				</tr>
			...
			$array=explode('.',$total_venta);
			 ?>
			<div>
				<p>SON: <?php echo $letras.' Y '.$array[1]; ?>/100 SOLES</p>			
			</div>
