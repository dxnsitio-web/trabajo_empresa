...
<!-- Encabezado-->
		<page_header>
			...
			<table style="width: 95%" class="info">
		        <tr>
		        	<td style="width: 2%"></td> 
		        	<td style="width: 45%">Lopez de Zuñiga N° 254 Chancay - Huaral - Lima</td> 
		...
		<div class="cliente">
			...
			<table style="width: 100%;">
				<tr>
					...
					<td style="width: 20%"><b>Validez de la Oferta</b></td>
					<td style="width: 10%">: 15 dias</td>
		...
		<div  class="productos">
			<table   style="border: solid 0.3px #087DA2 ">
				...
				<tr style="text-align:center">
					...
					<td class="<?php echo $estilo; ?>" style="text-align:left; width: 60%"><?php echo $regd->descripcion; ?></td>
